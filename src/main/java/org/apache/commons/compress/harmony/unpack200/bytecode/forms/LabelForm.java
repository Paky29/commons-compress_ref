...
public class LabelForm extends ByteCodeForm {
    ...
    protected boolean labelFormWidened;

    public LabelForm(final int opcode, final String name, final int[] rewrite) {
        super(opcode, name, rewrite);
    }

    public LabelForm(final int opcode, final String name, final int[] rewrite, final boolean labelFormWidened) {
        this(opcode, name, rewrite);
        this.labelFormWidened = labelFormWidened;
    }
